...
public class TestConstants {
  ...
  public static final Float EXPENSE_AMOUNT_2 = 3.5F;
  public static final String EXPENSE_DESCRIPTION = "WATER";
  public static final String EXPENSE_DESCRIPTION_2 = "CURRENCY";
  public static final LocalDate EXPENSE_DATE = LocalDate.now();
  public static final LocalDate EXPENSE_DATE_2 = LocalDate.now().plusDays(1);
  ...
  public static final String CATEGORY_EXPENSE_TYPE_2 = "EARN";
