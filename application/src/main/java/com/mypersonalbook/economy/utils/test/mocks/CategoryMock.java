...
public class CategoryMock {
  public static Category EXPENSE_CATEGORY =
      new Category(
          CATEGORY_ID, CATEGORY_NAME_UPPER_CASE, CATEGORY_EXPENSE_TRANSACTION_TYPE_UPPER_CASE);
  public static Category EXPENSE_CATEGORY_2 =
      new Category(
          CATEGORY_ID_2, CATEGORY_NAME_UPPER_CASE_2, CATEGORY_EXPENSE_TRANSACTION_TYPE_UPPER_CASE);
  public static Category REVENUE_CATEGORY =
      new Category(CATEGORY_ID_2, CATEGORY_NAME_UPPER_CASE_2, CATEGORY_TRANSACTION_TYPE_2);
