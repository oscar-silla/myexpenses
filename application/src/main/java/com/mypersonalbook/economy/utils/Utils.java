...
public class Utils {
  public static void validateOrThrowDateRange(
      LocalDate startDate, LocalDate endDate, Logger logger) {
  ...
  public static void validateOrThrowPagination(
      Integer pageNumber, Integer pageSize, Logger logger) {
