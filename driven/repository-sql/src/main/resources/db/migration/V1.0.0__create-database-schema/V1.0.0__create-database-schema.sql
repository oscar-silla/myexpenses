...
CREATE TABLE IF NOT EXISTS O_CATEGORIES(
    ...
    CONSTRAINT O_CATEGORIES_UQ UNIQUE (CATEGORY_NAME, TRANSACTION_TYPE_ID, USER_ID),
    ...
    CONSTRAINT O_CATEGORIES_O_USERS FOREIGN KEY (USER_ID) REFERENCES O_USERS (USER_ID)
);
...
COMMENT ON COLUMN O_CATEGORIES.USER_ID IS 'User identifier, ex: 1';
...
COMMENT ON COLUMN O_TRANSACTIONS.USER_ID IS 'User identifier, ex: 1';
